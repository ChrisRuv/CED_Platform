    ...
    return (
        <div className={styles.content_wrap}>
            ...
            <h1 className={styles.title}>
                {data.title_line1} <br />
                {data.title_line2} <span className={styles.title_accent}>{data.title_accent}</span>
            </h1>
            ...
            <div className={styles.btn_row}>
                <a href={data.cta_primary.href} className={styles.btn_primary}>
                    {data.cta_primary.label} <ChevronRight size={18} className="translate-x-0 group-hover:translate-x-1 transition-transform" />
                </a>
